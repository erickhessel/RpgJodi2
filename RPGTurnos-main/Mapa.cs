...
namespace RPGturnos1
{
    class Mapa
    {
        ...
        public void Porto()
        {
            ...
            Console.WriteLine("Ilha Solitária ou voltar para a Cidade Central");
     ...
     public void Deserto()
        {
            destino = "";
            Console.Clear();
            Console.WriteLine("Você está no Deserto sem Fim.");
            Console.ReadKey();
            Console.WriteLine("Não tem nada aqui.");
            Console.Clear();
            Console.WriteLine("A Cidade Central é a sua única saída.");
            Console.WriteLine("Você deseja voltar?");
            destino = Console.ReadLine();
            if (destino == "sim")
            {
                cidadeCentral();
        ...
        {
            Console.Clear();
            Console.WriteLine("Você está nas Minas Esquecidas.");
        }
        public void Floresta()
        {
            Console.Clear();
                Console.WriteLine("Você esta na floresta");
                Console.WriteLine("Não tem nada aqui, deseja voltar?");
                Console.WriteLine("1-Sim 2-Não")
                Console.ReadKey();
                if (1 = Voltar )
            {
